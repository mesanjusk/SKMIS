...
export default function Contact() {
  const [form, setForm] = useState({
    name: '', phone: '', institution: '', type: '', city: '', message: '',
  })
  ...
  const info = [
    { icon: '📍', label: 'Address', value: 'Gondia, Maharashtra, India' },
    { icon: '📞', label: 'Phone', value: '+91 XXXXXXXXXX' },
    { icon: '📧', label: 'Email', value: 'info@instify.in' },
    { icon: '🌐', label: 'Website', value: 'instify.in' },
    { icon: '💬', label: 'WhatsApp', value: '+91 XXXXXXXXXX' },
  ]
          ...
          <FadeIn delay={0}>
            <div style={{ flex: '1 1 300px' }}>
              ...
              <div style={{ marginTop: 28 }}>
                <p style={{ fontSize: 15, color: C.textGray, marginBottom: 14 }}>
                  या directly WhatsApp करें:
                </p>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      <div>
                        ...
                        <input name="name" required value={form.name} onChange={handleChange}
                          ...
                          style={getInputStyle('name')} placeholder="आपका नाम" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input name="institution" required value={form.institution} onChange={handleChange}
                          ...
                          style={getInputStyle('institution')} placeholder="आपकी institution का नाम" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input name="city" value={form.city} onChange={handleChange}
                          ...
                          style={getInputStyle('city')} placeholder="आपका शहर" />
                      </div>
                      <div>
                        ...
                        <textarea name="message" rows={4} value={form.message} onChange={handleChange}
                          ...
                          placeholder="कोई भी सवाल या requirement..." />
                      </div>
